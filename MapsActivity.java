...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    public void onMapReady(GoogleMap googleMap) {
        mMap = googleMap;
        LatLng Otp_area = new LatLng(28.67585704,77.1130359);
        ...
        GeoQuery geoQuery =geoFire.queryAtLocation(new GeoLocation(Otp_area.latitude,Otp_area.longitude),0.05f);
...
/*
               ...
               /*
                ...
                alarmManager.setRepeating(AlarmManager.RTC,calender.getTimeInMillis(),AlarmManager.INTERVAL_DAY,pendingIntent); */
            }
